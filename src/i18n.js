...
export const NARRATIVE_I18N = {
    'en': {
        ...
        'Separate API for Retrieval': 'Separate API for Retrieval',
        'Split retrieval from maintenance API. Maintenance handles STM/State/LTM extraction; retrieval handles Smart Push / recall.':
            'Split retrieval from maintenance API. Maintenance handles STM/State/LTM extraction; retrieval handles Smart Push / recall.',
        'Maintenance API (Pipeline)': 'Maintenance API (Pipeline)',
        'Retrieval API (Smart Push)': 'Retrieval API (Smart Push)',
    ...
    'zh-cn': {
        ...
        'Separate API for Retrieval': '检索与维护分离',
        'Split retrieval from maintenance API. Maintenance handles STM/State/LTM extraction; retrieval handles Smart Push / recall.':
            '将检索 API 与维护 API 分离。维护负责 STM/状态/LTM 提取；检索负责 Smart Push / recall。',
        'Maintenance API (Pipeline)': '维护 API（记忆提取）',
        'Retrieval API (Smart Push)': '检索 API（智能推送）',
        ...
        'Extraction Temperature (rec. 0.2)': '记忆提取温度 (推荐0.2)', 'Retrieval Temperature (rec. 0.3)': '检索温度 (推荐0.3)',
    ...
    'zh-tw': {
        ...
        'API URL': 'API URL', 'API Key': 'API Key', 'Model': '模型',
        'Separate API for Retrieval': '檢索與維護分離',
        'Split retrieval from maintenance API. Maintenance handles STM/State/LTM extraction; retrieval handles Smart Push / recall.':
            '將檢索 API 與維護 API 分離。維護負責 STM/狀態/LTM 提取；檢索負責 Smart Push / recall。',
        'Maintenance API (Pipeline)': '維護 API（記憶提取）',
        'Retrieval API (Smart Push)': '檢索 API（智能推送）',
        ...
        'Extraction Temperature (rec. 0.2)': '記憶提取溫度 (推薦0.2)', 'Retrieval Temperature (rec. 0.3)': '檢索溫度 (推薦0.3)',
