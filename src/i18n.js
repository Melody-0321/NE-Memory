...
export const NARRATIVE_I18N = {
    'en': {
        ...
        'Enable Narrative Engine': 'Enable Narrative Engine', 'Enable GM Agent': 'Enable GM Agent',
    ...
    'zh-cn': {
        ...
        'Invalid JSON': '无效JSON',
        'Enable Narrative Engine': '启用Narrative Engine', 'Enable GM Agent': '启用GM代理',
    ...
    'zh-tw': {
        ...
        'Invalid JSON': '無效JSON',
        'Enable Narrative Engine': '啟用Narrative Engine', 'Enable GM Agent': '啟用GM代理',
