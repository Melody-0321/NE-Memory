...
export const NARRATIVE_I18N = {
    ...
    'zh-cn': {
        ...
        'History': '历史', 'Extract State': '提取状态', 'Consolidate': '整合', 'Process History': '处理历史', 'Processing...': '处理中...', 'Process all past messages into memories': '将全部历史消息处理为记忆', 'No messages found in chat.': '未在聊天记录中找到消息。', 'No messages with content to process.': '没有可处理的有效消息。', 'Export JSON': '导出 JSON', 'Import JSON': '导入 JSON', 'Clear': '清除',
    ...
    'zh-tw': {
        ...
        'History': '歷史', 'Extract State': '提取狀態', 'Consolidate': '整合', 'Process History': '處理歷史', 'Processing...': '處理中...', 'Process all past messages into memories': '將全部歷史訊息處理為記憶', 'No messages found in chat.': '未在聊天記錄中找到訊息。', 'No messages with content to process.': '沒有可處理的有效訊息。', 'Export JSON': '匯出 JSON', 'Import JSON': '匯入 JSON', 'Clear': '清除',
