...
export const NARRATIVE_I18N = {
    'en': {
        ...
        'Invalid JSON': 'Invalid JSON', 'Save failed': 'Save failed', 'Saved': 'Saved', 'Delete failed': 'Delete failed',
    ...
    'zh-cn': {
        ...
        'Invalid JSON': '无效JSON', 'Save failed': '保存失败', 'Saved': '已保存', 'Delete failed': '删除失败',
    ...
    'zh-tw': {
        ...
        'Invalid JSON': '無效JSON', 'Save failed': '保存失敗', 'Saved': '已保存', 'Delete failed': '刪除失敗',
