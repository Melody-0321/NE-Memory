...
export const NARRATIVE_I18N = {
    'en': {
        ...
        'Disable State Schema': 'Disable State Schema',
        'When enabled, stops auto-tracking character state and injecting State Table. Use for MVU variable cards that manage state independently. STM/LTM memory continues.': 'Stops auto-tracking character state and State Table injection. For MVU variable cards with independent state systems. STM/LTM memory unaffected.',
        'NE State Schema auto-disabled (MVU card detected). Re-enable in Advanced Settings.': 'NE State Schema auto-disabled (MVU card detected). Re-enable in Advanced Settings.',
    ...
    'zh-cn': {
        ...
        'Disable State Schema': '关闭 State Schema',
        'When enabled, stops auto-tracking character state and injecting State Table. Use for MVU variable cards that manage state independently. STM/LTM memory continues.': '开启后停止自动追踪角色状态和注入 State Table。适用于使用 MVU 变量卡等已有独立状态系统的场景。STM/LTM 记忆不受影响。',
        'NE State Schema auto-disabled (MVU card detected). Re-enable in Advanced Settings.': 'NE State Schema 已自动关闭（检测到 MVU 变量卡）。可在高级设置中重新开启。',
    ...
    'zh-tw': {
        ...
        'Disable State Schema': '關閉 State Schema',
        'When enabled, stops auto-tracking character state and injecting State Table. Use for MVU variable cards that manage state independently. STM/LTM memory continues.': '開啟後停止自動追蹤角色狀態和注入 State Table。適用於使用 MVU 變量卡等已有獨立狀態系統的情境。STM/LTM 記憶不受影響。',
        'NE State Schema auto-disabled (MVU card detected). Re-enable in Advanced Settings.': 'NE State Schema 已自動關閉（偵測到 MVU 變量卡）。可在進階設定中重新開啟。',
