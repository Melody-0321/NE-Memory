...
export const NARRATIVE_I18N = {
    'en': {
        ...
        'floor_panel_title': 'Memory Summary',
        'floor_panel_no_summary': 'No summary for this message',
        'floor_panel_locate_in_main': 'View in main panel',
        'floor_panel_enabled': 'Floor Panel',
        'floor_panel_enabled_desc': 'Show a memory summary button under each AI message. Click to expand the STM entry for that floor.',
    ...
    'zh-cn': {
        ...
        'summary_only_notice_body': '副 API 仍会分析并更新柏宝书账本。状态/STM/LTM 数据持续维护，但不注入主对话。其他插件/宏仍可读取这些数据。',
        'floor_panel_title': '记忆摘要',
        'floor_panel_no_summary': '此消息暂无摘要',
        'floor_panel_locate_in_main': '在主面板查看',
        'floor_panel_enabled': '楼内摘要面板',
        'floor_panel_enabled_desc': '在每条 AI 消息下方显示记忆摘要按钮，点击展开该楼的 STM 摘要条目。',
    ...
    'zh-tw': {
        ...
        'summary_only_notice_body': '副 API 仍會分析並更新柏寶書帳本。狀態/STM/LTM 資料持續維護，但不注入主對話。其他插件/巨集仍可讀取這些資料。',
        'floor_panel_title': '記憶摘要',
        'floor_panel_no_summary': '此訊息暫無摘要',
        'floor_panel_locate_in_main': '在主面板查看',
        'floor_panel_enabled': '樓內摘要面板',
        'floor_panel_enabled_desc': '在每條 AI 訊息下方顯示記憶摘要按鈕，點擊展開該樓的 STM 摘要條目。',
        'meta_ltm_enabled': 'Meta-LTM（跨弧摘要）',
