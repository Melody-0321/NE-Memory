...
export var DEFAULT_PC_TEMPLATE = {
    ...
    name: 'Default PC',
    role: 'pc',
    description: 'Default protagonist scheme (12 preset fields)',
    source: 'system',
    system: true,
    presetFields: ['gender_age','physique','occupation','personality','clothing_build','current_outfit','injuries','status_effects','past_experience','inventory','abilities','power_level'],
    customFieldRefs: [],
...
export var DEFAULT_NPC_TEMPLATE = {
    ...
    name: 'Default NPC',
    role: 'npc',
    description: 'Default NPC scheme (15 preset fields)',
    source: 'system',
    system: true,
    presetFields: ['gender_age','physique','occupation','personality','clothing_build','current_outfit','inner_thoughts','relationship','current_mood','past_experience','injuries','status_effects','inventory'],
    customFieldRefs: [],
    perRoundFields: ['current_mood', 'inner_thoughts'],
    _locked: false
};
