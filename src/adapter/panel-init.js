...
export async function renderVaultPanel(getChatId) {
    try {
        ...
        var drawerHtml = '<div id="ne_vault_bottom_overlay" class="ne-vault-bottom-overlay">' +
            ...
            '<span id="narrative_secondary_api_status" style="font-size:0.75em;color:var(--ne-muted);cursor:help;" title="' + t('No secondary API configured') + '"><i class="fa-regular fa-circle"></i></span>' +
