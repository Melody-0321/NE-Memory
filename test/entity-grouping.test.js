...
eq(r7.unassigned.length, 1, 'unassigned with relevance>0 kept');

var m7b = new Map();
m7b.set('stm_zero', {
    entry: { id: 'stm_zero', event: 'zero relevance', period: 'Day 1', entities: [] },
    relevance: 0
});
var r7b = groupCandidatesByEntity(m7b, {});
eq(r7b.unassigned.length, 0, 'unassigned with relevance=0 filtered out');
